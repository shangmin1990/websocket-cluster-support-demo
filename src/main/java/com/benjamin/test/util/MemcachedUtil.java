package com.benjamin.test.util;
...
public class MemcachedUtil {
  ...
  private static Logger logger = Logger.getLogger(com.benjamin.websocket.util.MemcachedUtil.class);
...
//  @Value("memcached.port")
  ...
  static {
    try {
      InputStream inputStream = com.benjamin.websocket.util.MemcachedUtil.class.getClassLoader().getResourceAsStream("/config/memcache.properties");
      if(inputStream == null){
